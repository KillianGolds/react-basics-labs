...
function App() {
  const [taskState, setTaskState] = useState({
    tasks: [
      ...
      { id: 4, title: "Grocery shopping", description: "Buy groceries for the week",  deadline: "Next week", priority: "Low", done: false },
      { id: 5, title: "Write report", description: "Complete the project report", deadline: "Friday", priority: "Low", done: false },
    ]
  });
